                                        ...
                                        <li className="mr-3 flex-1">
                                            <Link href="/">
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        className="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block"></span>
                                                </a>
                                            </Link>
                                        </li>
                            ...
                            >
                                <div className="bg-gray-800 pt-3">
                                    <div
                                        ...
                                        <h1 className="font-bold pl-2">Online Laptop details</h1>
                                    </div>
                                </div>
